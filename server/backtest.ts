...
export function runBacktest(
  ...
  return {
    ...
    limitsAr: [
      ...
      'عامل الزخم 24h معطل داخل الباك تست (التغير اليومي التاريخي غير متاح) — لا تُقارن النتائج الحية حرفياً بالمحاكاة',
      'عوامل التمويل وOpen Interest وFear & Greed وتدفقات الحيتان غير متاحة تاريخياً داخل الباك تست — نتائج الشموع لا تمثل كل عوامل المسح الحي',
      'طبقة السيولة (DefiLlama) معطلة داخل الباك تست — بياناتها التاريخية غير متاحة مجاناً',
      'المسح الحي قد يقرأ أحدث شمعة 1h قيد التكوّن، بينما الباك تست يعيد تشغيل شموع تاريخية؛ لذلك قد يختلف توقيت الإشارة',
